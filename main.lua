...
-- 実行ループ
local function loop()
    while running and MainGui and MainGui.Parent do
        local success, errorMsg = pcall(function()
            event:FireServer(unpack(getArgs()))
        end)
...
StartBtn.MouseButton1Click:Connect(function()
    if not running then
        ...
        StartBtn.BackgroundColor3 = Color3.fromRGB(255, 149, 0)
